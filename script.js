...
function onDeleteTodo(todoId) {
    ...
    let deleteTodoId = todoList.findIndex(function(eachItem) {
        let deleteId = "todo" + eachItem.uniqueNo;
        if (deleteId === todoElement) {
            return true;
        } else {
            return false;
        }
...
function onTodoStatusChange(checkboxId, labelId,todoId) {
    ...
    let todoItemIndex = todoList.findIndex(function(eachItem){
        let todoItemId = "todo" + eachItem.uniqueNo;
...
function createAndAppendTodo(todo) {
    ...
    deleteIcon.classList.add("bi","bi-trash-fill","delete-icon");
